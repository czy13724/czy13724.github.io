...
subtitle: "新版通常可直接接入；若你的环境是旧版本或精简构建，再按插件模式安装"
...
![OpenClaw Feishu Channel Doc]({{ site.baseurl }}/img/openclaw/openclaw-feishu-og.png)
...
![Create Feishu App]({{ site.baseurl }}/img/openclaw/feishu-step2-create-app.png)
*图：飞书应用创建页面（官方文档截图）。*

![Get Feishu Credentials]({{ site.baseurl }}/img/openclaw/feishu-step3-credentials.png)
*图：飞书应用凭据获取位置（官方文档截图）。*

![Configure Feishu Permissions]({{ site.baseurl }}/img/openclaw/feishu-step4-permissions.png)
*图：飞书权限配置页面（官方文档截图）。*
