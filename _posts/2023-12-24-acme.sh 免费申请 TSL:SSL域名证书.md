...
vlook-chp-autonum: \${vlook-chp-autonum}
vlook-doc-lib: \${vlook-doc-lib}
vlook-image-host: \${vlook-image-host}
vlook-query: \${vlook-query}
vlook-var: \${vlook-var}
vlook-welcome: \${vlook-welcome}
tags:
    - 教程 
---
...
![1]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/1.png)
...
![2]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/2.png)

![3]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/3.png)

![4]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/4.png)

依照上述图片设置即可，添加区域-DNS-编辑和区域-区域-读取权限，区域资源里面选择包括-账户的所有区域-你的账户。

![5]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/5.png)
...
![6]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/6.png)

下拉，找到API区域：

![7]({{site.baseurl}}/img/How_To_Get_TSL/SSL_Certificate/7.png)
